...
from ibm_botocore.exceptions import NoRegionError, EndpointVariantError
...
class TestEndpointResolver(unittest.TestCase):
    ...
    #     resolver = regions.EndpointResolver(self._template())
    #     with self.assertLogs('ibm_botocore.regions', level='WARNING') as log:
...
def _verify_expected_endpoint(service, region,
                              # IBM Unsupported
                              # fips, 
                              dualstack,
                              endpoint):

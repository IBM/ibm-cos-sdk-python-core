...
from ibm_botocore.awsrequest import AWSRequest, AWSPreparedRequest, AWSResponse
from ibm_botocore.awsrequest import AWSHTTPConnection, AWSHTTPSConnection, HeadersDict

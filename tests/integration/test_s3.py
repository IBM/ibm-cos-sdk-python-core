...
from ibm_botocore.compat import OrderedDict, zip_longest
from ibm_botocore.config import Config
from ibm_botocore.exceptions import ClientError, ConnectionClosedError, WaiterError
from tests import (
    ClientHTTPStubber,
    ConsistencyWaiter,
    random_chars,
...
def clear_out_bucket(bucket, region, delete_bucket=False):
    s3 = ibm_botocore.session.get_session().create_client('s3', region_name=region)

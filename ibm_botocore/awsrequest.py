...
from ibm_botocore.vendored.requests import models
from ibm_botocore.vendored.requests.sessions import REDIRECT_STATI
from ibm_botocore.vendored.requests.packages.urllib3.connection import \
    VerifiedHTTPSConnection
from ibm_botocore.vendored.requests.packages.urllib3.connection import \
    HTTPConnection
from ibm_botocore.vendored.requests.packages.urllib3.connectionpool import \
    HTTPConnectionPool
from ibm_botocore.vendored.requests.packages.urllib3.connectionpool import \
    HTTPSConnectionPool

...
import ibm_botocore.configprovider
...
from ibm_botocore.configprovider import ConfiguredEndpointProvider
from ibm_botocore.configprovider import SectionConfigProvider
...
#             ibm_botocore.configprovider.os, 'environ',

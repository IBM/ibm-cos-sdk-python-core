# -*- coding: utf-8 -*-
#
# ibm_botocore documentation build configuration file, created by
...
release = ibm_botocore.__version__
...
htmlhelp_basename = 'ibm-cos-sdk-coredoc'
...
latex_documents = [
  ('index', 'ibm_botocore.tex', u'ibm_botocore Documentation',
...
man_pages = [
    ('index', 'ibm_botocore', u'ibm_botocore Documentation',
     [u'Mitch Garnaat'], 3)
]
...
texinfo_documents = [
  ('index', 'ibm_botocore', u'ibm_botocore Documentation',
   u'Mitch Garnaat', 'ibm_botocore', 'One line description of project.',
   'Miscellaneous'),
]

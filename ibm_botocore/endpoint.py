...
from ibm_botocore.vendored.requests.adapters import HTTPAdapter
from ibm_botocore.vendored.requests.sessions import Session
from ibm_botocore.vendored.requests.utils import get_environ_proxies
...
from ibm_botocore.compat import filter_ssl_warnings
...
try:
    from ibm_botocore.vendored.requests.packages.urllib3.contrib import pyopenssl

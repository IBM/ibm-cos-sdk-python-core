...
@mock.patch.object(
    ibm_botocore.useragent, 'modify_components', unmodified_components
)
def test_basic_user_agent_string():
    ...
    actual = ua.to_string()
    expected = (
        f'Botocore/{ibm_botocore_version} '
        'md/awscrt#Unknown '
        'ua/2.0 '
        'os/linux#1.2.3-foo '
        'md/arch#x86_64 '
...
def test_user_agent_string_with_missing_information():
    ...
    assert actual == f'Botocore/{ibm_botocore_version} ua/2.0 os/other lang/python'

...
from ibm_botocore.compat import json, six
...
from ibm_botocore.utils import FileWebIdentityTokenLoader, SSOTokenLoader
from ibm_botocore.credentials import EnvProvider, create_assume_role_refresher
from ibm_botocore.credentials import CredentialProvider, AssumeRoleProvider
from ibm_botocore.credentials import ConfigProvider, SharedCredentialProvider
from ibm_botocore.credentials import ProcessProvider
from ibm_botocore.credentials import AssumeRoleWithWebIdentityProvider
from ibm_botocore.credentials import Credentials, ProfileProviderBuilder
from ibm_botocore.credentials import SSOCredentialFetcher, SSOProvider
...
class TestRefreshableCredentials(TestCredentials):
    ...
    def test_refresh_returns_empty_dict(self):
        ...
        with self.assertRaises(ibm_botocore.exceptions.CredentialRetrievalError):
...
class TestCreateCredentialResolver(BaseEnvVar):
    def setUp(self):
        ...
        self.session = mock.Mock(spec=ibm_botocore.session.Session)
...
class TestAssumeRoleCredentialProvider(unittest.TestCase):
    ...
    def test_assume_role_populates_session_name_on_refresh(self):
        ...
        with mock.patch('ibm_botocore.credentials._local_now', local_now):
    ...
    def test_infinite_looping_profiles_raises_error(self):
        ...
        with self.assertRaises(ibm_botocore.credentials.InfiniteLoopConfigError):
            provider.load()
